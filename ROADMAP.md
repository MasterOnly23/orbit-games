...
- Último incremento cerrado: lector paginado de catálogo EA basado en una referencia comunitaria actual, con controles de integridad y pruebas sintéticas. Adaptador EA integrado al contrato de ventana aislada; recorrido completo y registro visible pendientes. Véase EA_SUPPORT.md.
